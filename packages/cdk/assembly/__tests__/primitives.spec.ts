...
describe("DFINITY Primitives encode and decoding", () => {
  ...
  it("Should decode and encode a string", () => {
    ...
    var encoder = new Encoder([IDL.getType<string>()]);
  ...
  it("Should decode and encode a bool", () => {
    ...
    var encoder = new Encoder([IDL.getType<boolean>()]);
    ...
    encoder = new Encoder([IDL.getType<boolean>()]);
  ...
  it("Should decode and encode a u8", () => {
    ...
    var encoder = new Encoder([IDL.getType<u8>()]);
  ...
  it("Should decode and encode a u32", () => {
    ...
    var encoder = new Encoder([IDL.getType<u32>()]);
  ...
  it("Should decode and encode a u64", () => {
    ...
    var encoder = new Encoder([IDL.getType<u64>()]);
  ...
  it("Should decode and encode a i8", () => {
    ...
    var encoder = new Encoder([IDL.getType<i8>()]);
  ...
  it("Should decode and encode a i32", () => {
    ...
    var encoder = new Encoder([IDL.getType<i32>()]);
  ...
  it("Should decode and encode a i64", () => {
    ...
    var encoder = new Encoder([IDL.getType<i64>()]);
  ...
  it("Should decode and encode a f32", () => {
    ...
    var encoder = new Encoder([IDL.getType<f32>()]);
  ...
  it("Should decode and encode a f64", () => {
    ...
    var encoder = new Encoder([IDL.getType<f64>()]);
